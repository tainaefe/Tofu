...
class AccountTests: XCTestCase {
  func testInitWithURL() {
    ...
    XCTAssertEqual(account?.password.secret, NSData(base32EncodedString: "JBSWY3DPEHPK3PXP")!)
    ...
    account = Account(url: NSURL(string: "otpauth://totp/alice@example.com")!)
    XCTAssertNil(account)

    account = Account(url: NSURL(string: "otpauth://totp/alice@example.com?secret=AAA")!)
    XCTAssertNil(account)
